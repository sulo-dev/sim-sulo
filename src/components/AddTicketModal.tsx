...
export default function AddTicketModal({ isOpen, onClose }: Props) {
        ...
        <AnimatePresence mode="wait">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      >
                        ...
                        <option value="3">SULO-MIS (Internal)</option>
                        <option value="4">Sistem HRD Internal</option>
                      </select>
                    </div>
                    <div>
          ...
          {submitStatus === 'success' && (
            ...
            >
              ...
              <h3 className="relative z-10 text-2xl font-black text-slate-900 dark:text-white mb-2">Tiket Berhasil Dibuat!</h3>
              <p className="relative z-10 text-sm font-medium text-slate-500 dark:text-slate-400 mb-8 max-w-sm mx-auto">
                Laporan masalah telah masuk ke antrean Helpdesk dan akan segera ditindaklanjuti oleh tim teknis.
              </p>
